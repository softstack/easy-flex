...
var createModal = function () {
    var Modal = (0, react_1.memo)(function (_a) {
        var _b;
        var backgroundColor = _a.backgroundColor, blur = _a.blur, children = _a.children, containerElementId = _a.containerElementId, display = _a.display, onClose = _a.onClose, visibility = _a.visibility, props = __rest(_a, ["backgroundColor", "blur", "children", "containerElementId", "display", "onClose", "visibility"]);
        var theme = (0, base_1.useEasyFlexTheme)();
        var miscStyleProps = (0, misc_1.useMiscStyleProps)({ display: (_b = (0, base_1.defalsify)(display)) !== null && _b !== void 0 ? _b : 'flex', visibility: visibility });
