...
export declare type ElementSize = ExtSize | 'auto' | 'fit-content' | 'max-content' | 'min-content' | 'none';
...
export declare type JustifyContent = GlobalValue | 'center' | 'end' | 'flex-end' | 'flex-start' | 'space-around' | 'space-between' | 'space-evenly' | 'start' | 'stretch';
export declare type JustifyItems = GlobalValue | 'center' | 'end' | 'start' | 'stretch';
...
export declare type ZIndex = GlobalValue | 'auto' | number;
