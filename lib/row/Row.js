...
var createRow = function () {
    ...
    var Row = (0, react_1.memo)((0, react_1.forwardRef)(function (_a, ref) {
        var children = _a.children, flip = _a.flip, flipDirection = _a.flipDirection, viewport = _a.viewport, props = __rest(_a, ["children", "flip", "flipDirection", "viewport"]);
                ...
                (flip ||
                    (flip === undefined &&
                        (viewport !== false && viewport !== undefined
                            ? width < (0, base_1.getViewportThreshold)(theme, viewport)
        ...
        return ((0, jsx_runtime_1.jsx)(BaseFlex, __assign({ direction: direction, ref: ref }, props, { children: children })));
    }));
    Row.displayName = 'Row';
    return Row;
};
