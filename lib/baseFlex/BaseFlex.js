...
exports.BaseFlex = (0, react_1.forwardRef)(function (_a, ref) {
    ...
    var columnGap = (0, react_1.useMemo)(function () {
        ...
        if (flexDirection === 'row' || flexDirection === 'row-reverse') {
            return (0, utils_1.getDistance)(theme, gap);
        }
        return undefined;
