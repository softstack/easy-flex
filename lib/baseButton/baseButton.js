...
var BaseButton = function (_a) {
    var align = _a.align, alignSelf = _a.alignSelf, backgroundColor = _a.backgroundColor, borderColor = _a.borderColor, borderRadius = _a.borderRadius, borderWidth = _a.borderWidth, children = _a.children, color = _a.color, _b = _a.fullHeight, fullHeight = _b === void 0 ? false : _b, _c = _a.fullWidth, fullWidth = _c === void 0 ? false : _c, grow = _a.grow, height = _a.height, justify = _a.justify, margin = _a.margin, marginBottom = _a.marginBottom, marginLeft = _a.marginLeft, marginRight = _a.marginRight, marginTop = _a.marginTop, marginX = _a.marginX, marginY = _a.marginY, maxHeight = _a.maxHeight, maxWidth = _a.maxWidth, minHeight = _a.minHeight, minWidth = _a.minWidth, padding = _a.padding, paddingBottom = _a.paddingBottom, paddingLeft = _a.paddingLeft, paddingRight = _a.paddingRight, paddingTop = _a.paddingTop, paddingX = _a.paddingX, paddingY = _a.paddingY, shrink = _a.shrink, width = _a.width, props = __rest(_a, ["align", "alignSelf", "backgroundColor", "borderColor", "borderRadius", "borderWidth", "children", "color", "fullHeight", "fullWidth", "grow", "height", "justify", "margin", "marginBottom", "marginLeft", "marginRight", "marginTop", "marginX", "marginY", "maxHeight", "maxWidth", "minHeight", "minWidth", "padding", "paddingBottom", "paddingLeft", "paddingRight", "paddingTop", "paddingX", "paddingY", "shrink", "width"]);
    ...
    return ((0, jsx_runtime_1.jsx)(StyledBaseButton, __assign({ "data-align": align, "data-align-self": alignSelf, "data-background-color": processedBackgroundColor, "data-border-color": processedBorderColor, "data-border-radius": processedBorderRadius, "data-border-style": processedBorderStyle, "data-border-width": processedBorderWidth, "data-color": processedColor, "data-grow": grow, "data-height": size.height, "data-height-max": size.heightMax, "data-height-min": size.heightMin, "data-justify": justify, "data-margin-bottom": distance.margin.bottom, "data-margin-left": distance.margin.left, "data-margin-right": distance.margin.right, "data-margin-top": distance.margin.top, "data-padding-bottom": distance.padding.bottom, "data-padding-left": distance.padding.left, "data-padding-right": distance.padding.right, "data-padding-top": distance.padding.top, "data-shrink": shrink, "data-width": size.width, "data-width-max": size.widthMax, "data-width-min": size.widthMin }, props, { children: children })));
};
