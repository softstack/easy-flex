...
exports.BaseButton = (0, react_1.forwardRef)(function (_a, ref) {
    ...
    var colorStyleProps = (0, color_1.useColorStyleProps)({ backgroundColor: backgroundColor, color: color }, 'transparent', undefined);
    ...
    return ((0, jsx_runtime_1.jsx)(StyledBaseButton, __assign({}, borderStyleProps, colorStyleProps, distanceStyleProps, flexContainerStyleProps, flexItemStyleProps, fontStyleProps, overflowStyleProps, sizeStyleProps, { ref: ref }, props, { children: children })));
});
