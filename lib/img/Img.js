...
var createImg = function () {
    var Img = (0, react_1.memo)((0, react_1.forwardRef)(function (_a, ref) {
        var aspectRatio = _a.aspectRatio, backgroundColor = _a.backgroundColor, borderColor = _a.borderColor, borderRadius = _a.borderRadius, borderStyle = _a.borderStyle, borderWidth = _a.borderWidth, color = _a.color, displayNone = _a.displayNone, fullHeight = _a.fullHeight, fullWidth = _a.fullWidth, height = _a.height, justifySelf = _a.justifySelf, margin = _a.margin, marginBottom = _a.marginBottom, marginHorizontal = _a.marginHorizontal, marginLeft = _a.marginLeft, marginRight = _a.marginRight, marginTop = _a.marginTop, marginVertical = _a.marginVertical, maxHeight = _a.maxHeight, maxWidth = _a.maxWidth, minHeight = _a.minHeight, minWidth = _a.minWidth, objectFit = _a.objectFit, opacity = _a.opacity, round = _a.round, visibility = _a.visibility, width = _a.width, props = __rest(_a, ["aspectRatio", "backgroundColor", "borderColor", "borderRadius", "borderStyle", "borderWidth", "color", "displayNone", "fullHeight", "fullWidth", "height", "justifySelf", "margin", "marginBottom", "marginHorizontal", "marginLeft", "marginRight", "marginTop", "marginVertical", "maxHeight", "maxWidth", "minHeight", "minWidth", "objectFit", "opacity", "round", "visibility", "width"]);
