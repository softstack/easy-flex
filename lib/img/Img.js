...
var createImg = function () {
    var Img = (0, react_1.memo)((0, react_1.forwardRef)(function (_a, ref) {
        var aspectRatio = _a.aspectRatio, backgroundColor = _a.backgroundColor, borderColor = _a.borderColor, borderRadius = _a.borderRadius, borderStyle = _a.borderStyle, borderWidth = _a.borderWidth, bottom = _a.bottom, color = _a.color, displayNone = _a.displayNone, fullHeight = _a.fullHeight, fullWidth = _a.fullWidth, height = _a.height, justifySelf = _a.justifySelf, left = _a.left, margin = _a.margin, marginBottom = _a.marginBottom, marginHorizontal = _a.marginHorizontal, marginLeft = _a.marginLeft, marginRight = _a.marginRight, marginTop = _a.marginTop, marginVertical = _a.marginVertical, maxHeight = _a.maxHeight, maxWidth = _a.maxWidth, minHeight = _a.minHeight, minWidth = _a.minWidth, objectFit = _a.objectFit, opacity = _a.opacity, position = _a.position, right = _a.right, round = _a.round, top = _a.top, visibility = _a.visibility, width = _a.width, props = __rest(_a, ["aspectRatio", "backgroundColor", "borderColor", "borderRadius", "borderStyle", "borderWidth", "bottom", "color", "displayNone", "fullHeight", "fullWidth", "height", "justifySelf", "left", "margin", "marginBottom", "marginHorizontal", "marginLeft", "marginRight", "marginTop", "marginVertical", "maxHeight", "maxWidth", "minHeight", "minWidth", "objectFit", "opacity", "position", "right", "round", "top", "visibility", "width"]);
