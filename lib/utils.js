...
var getHeight = function (theme, height) {
    return typeof height === 'number' ? height : theme.height[height];
};
exports.getHeight = getHeight;
var getWidth = function (theme, width) {
    return typeof width === 'number' ? width : theme.width[width];
};
...
var useDistance = function (_a) {
    ...
    var theme = (0, exports.useEasyFlexTheme)();
    var processedMarginBottom = (0, react_1.useMemo)(function () { var _a; return (0, exports.ifNotUndefined)((_a = marginBottom !== null && marginBottom !== void 0 ? marginBottom : marginY) !== null && _a !== void 0 ? _a : margin, function (margin) { return (0, exports.toPx)((0, exports.getDistance)(theme, margin)); }); }, [margin, marginBottom, marginY, theme]);
    var processedMarginLeft = (0, react_1.useMemo)(function () { var _a; return (0, exports.ifNotUndefined)((_a = marginLeft !== null && marginLeft !== void 0 ? marginLeft : marginX) !== null && _a !== void 0 ? _a : margin, function (margin) { return (0, exports.toPx)((0, exports.getDistance)(theme, margin)); }); }, [margin, marginLeft, marginX, theme]);
    var processedMarginRight = (0, react_1.useMemo)(function () { var _a; return (0, exports.ifNotUndefined)((_a = marginRight !== null && marginRight !== void 0 ? marginRight : marginX) !== null && _a !== void 0 ? _a : margin, function (margin) { return (0, exports.toPx)((0, exports.getDistance)(theme, margin)); }); }, [margin, marginRight, marginX, theme]);
    var processedMarginTop = (0, react_1.useMemo)(function () { var _a; return (0, exports.ifNotUndefined)((_a = marginTop !== null && marginTop !== void 0 ? marginTop : marginY) !== null && _a !== void 0 ? _a : margin, function (margin) { return (0, exports.toPx)((0, exports.getDistance)(theme, margin)); }); }, [margin, marginTop, marginY, theme]);
    var processedPaddingBottom = (0, react_1.useMemo)(function () { var _a; return (0, exports.ifNotUndefined)((_a = paddingBottom !== null && paddingBottom !== void 0 ? paddingBottom : paddingY) !== null && _a !== void 0 ? _a : padding, function (margin) { return (0, exports.toPx)((0, exports.getDistance)(theme, margin)); }); }, [padding, paddingBottom, paddingY, theme]);
    var processedPaddingLeft = (0, react_1.useMemo)(function () { var _a; return (0, exports.ifNotUndefined)((_a = paddingLeft !== null && paddingLeft !== void 0 ? paddingLeft : paddingX) !== null && _a !== void 0 ? _a : padding, function (margin) { return (0, exports.toPx)((0, exports.getDistance)(theme, margin)); }); }, [padding, paddingLeft, paddingX, theme]);
    var processedPaddingRight = (0, react_1.useMemo)(function () { var _a; return (0, exports.ifNotUndefined)((_a = paddingRight !== null && paddingRight !== void 0 ? paddingRight : paddingX) !== null && _a !== void 0 ? _a : padding, function (margin) { return (0, exports.toPx)((0, exports.getDistance)(theme, margin)); }); }, [padding, paddingRight, paddingX, theme]);
    var processedPaddingTop = (0, react_1.useMemo)(function () { var _a; return (0, exports.ifNotUndefined)((_a = paddingTop !== null && paddingTop !== void 0 ? paddingTop : paddingY) !== null && _a !== void 0 ? _a : padding, function (margin) { return (0, exports.toPx)((0, exports.getDistance)(theme, margin)); }); }, [padding, paddingTop, paddingY, theme]);
