...
var getBorderRadius = function (theme, borderRadius) {
    return (0, exports.isIThemeSize)(borderRadius) ? theme.border.radius[borderRadius] : borderRadius;
};
exports.getBorderRadius = getBorderRadius;
var getBorderWidth = function (theme, borderWidth) {
    return (0, exports.isIThemeSize)(borderWidth) ? theme.border.width[borderWidth] : borderWidth;
};
...
var getDistance = function (theme, distance) {
    return (0, exports.isIThemeSize)(distance) ? theme.distance[distance] : distance;
};
exports.getDistance = getDistance;
var getFontSize = function (theme, fontSize) {
    return (0, exports.isIThemeSize)(fontSize) ? theme.font.size[fontSize] : fontSize;
};
...
var getHeight = function (theme, height) {
    return (0, exports.isIThemeSize)(height) ? theme.size.height[height] : height;
};
...
var getWidth = function (theme, width) {
    return (0, exports.isIThemeSize)(width) ? theme.size.width[width] : width;
};
