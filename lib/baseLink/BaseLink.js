...
exports.BaseLink = (0, react_1.forwardRef)(function (_a, ref) {
    ...
    return ((0, jsx_runtime_1.jsx)(StyledBaseLink, __assign({ "data-hover-color": processedHoverColor }, colorStyleProps, flexItemStyleProps, fontStyleProps, marginStyleProps, sizeStyleProps, { rel: "noopener noreferrer", target: target, ref: ref }, props, { children: children })));
});
