...
var BaseLink = function (_a) {
    var alignSelf = _a.alignSelf, children = _a.children, color = _a.color, hoverColor = _a.hoverColor, margin = _a.margin, marginBottom = _a.marginBottom, marginLeft = _a.marginLeft, marginRight = _a.marginRight, marginTop = _a.marginTop, marginX = _a.marginX, marginY = _a.marginY, _b = _a.newTab, newTab = _b === void 0 ? false : _b, props = __rest(_a, ["alignSelf", "children", "color", "hoverColor", "margin", "marginBottom", "marginLeft", "marginRight", "marginTop", "marginX", "marginY", "newTab"]);
