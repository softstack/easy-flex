...
var Style = function (_a) {
    var backgroundColor = _a.backgroundColor, children = _a.children, color = _a.color, _b = _a.element, element = _b === void 0 ? 'span' : _b, fontSize = _a.fontSize, fontWeight = _a.fontWeight, italic = _a.italic, lineHeight = _a.lineHeight;
    ...
    return ((0, jsx_runtime_1.jsx)(Element, __assign({ "data-background-color": processedBackgroundColor, "data-color": processedColor, "data-font-size": processedFontSize, "data-font-weight": processedFontWeight, "data-font-wtyle": fontStyle, "data-line-height": processedLineHeight }, { children: children })));
};
exports.Style = Style;
