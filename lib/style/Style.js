...
var createStyle = function () {
    var Style = (0, react_1.memo)((0, react_1.forwardRef)(function (_a, ref) {
        var backgroundColor = _a.backgroundColor, bottom = _a.bottom, children = _a.children, color = _a.color, displayNone = _a.displayNone, element = _a.element, fontFamily = _a.fontFamily, fontSize = _a.fontSize, fontWeight = _a.fontWeight, italic = _a.italic, left = _a.left, lineHeight = _a.lineHeight, opacity = _a.opacity, position = _a.position, right = _a.right, top = _a.top, underline = _a.underline, userSelect = _a.userSelect, visibility = _a.visibility, whiteSpace = _a.whiteSpace, wordBreak = _a.wordBreak, props = __rest(_a, ["backgroundColor", "bottom", "children", "color", "displayNone", "element", "fontFamily", "fontSize", "fontWeight", "italic", "left", "lineHeight", "opacity", "position", "right", "top", "underline", "userSelect", "visibility", "whiteSpace", "wordBreak"]);
