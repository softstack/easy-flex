...
var Style = function (_a) {
    var backgroundColor = _a.backgroundColor, children = _a.children, color = _a.color, _b = _a.element, element = _b === void 0 ? 'span' : _b, fontFamily = _a.fontFamily, fontSize = _a.fontSize, fontWeight = _a.fontWeight, italic = _a.italic, lineHeight = _a.lineHeight;
    ...
    var processedFontFamily = (0, react_1.useMemo)(function () { return (0, utils_1.ifNotUndefined)(fontFamily, function (fontFamily) { return theme.font.family[fontFamily]; }); }, [fontFamily, theme]);
    var processedFontSize = (0, react_1.useMemo)(function () { return (0, utils_1.ifNotUndefined)(fontSize, function (fontSize) { return (0, utils_1.getFontSize)(theme, fontSize); }); }, [fontSize, theme]);
    ...
    var processedLineHeight = (0, react_1.useMemo)(function () { return (0, utils_1.ifNotUndefined)(lineHeight, function (lineHeight) { return (0, utils_1.getLineHeight)(theme, lineHeight); }); }, [lineHeight, theme]);
    ...
    return ((0, jsx_runtime_1.jsx)(Element, __assign({ "data-background-color": processedBackgroundColor, "data-color": processedColor, "data-font-family": processedFontFamily, "data-font-size": processedFontSize, "data-font-weight": processedFontWeight, "data-font-wtyle": fontStyle, "data-line-height": processedLineHeight }, { children: children })));
};
exports.Style = Style;
