...
var createStyle = function () {
    var Style = (0, react_1.forwardRef)(function (_a, ref) {
        var backgroundColor = _a.backgroundColor, children = _a.children, color = _a.color, _b = _a.element, element = _b === void 0 ? 'span' : _b, fontFamily = _a.fontFamily, fontSize = _a.fontSize, fontWeight = _a.fontWeight, italic = _a.italic, lineHeight = _a.lineHeight, underline = _a.underline, whiteSpace = _a.whiteSpace, wordBreak = _a.wordBreak;
