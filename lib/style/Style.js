...
var createStyle = function () {
    var Style = (0, react_1.memo)((0, react_1.forwardRef)(function (_a, ref) {
        var backgroundColor = _a.backgroundColor, children = _a.children, color = _a.color, displayNone = _a.displayNone, _b = _a.element, element = _b === void 0 ? 'span' : _b, fontFamily = _a.fontFamily, fontSize = _a.fontSize, fontWeight = _a.fontWeight, italic = _a.italic, lineHeight = _a.lineHeight, opacity = _a.opacity, underline = _a.underline, visibility = _a.visibility, whiteSpace = _a.whiteSpace, wordBreak = _a.wordBreak;
