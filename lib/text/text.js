...
var Text = function (_a) {
    var align = _a.align, alignSelf = _a.alignSelf, children = _a.children, _b = _a.color, color = _b === void 0 ? 'primaryText' : _b, _c = _a.element, element = _c === void 0 ? 'p' : _c, _d = _a.fontSize, fontSize = _d === void 0 ? 'm' : _d, _e = _a.fontWeight, fontWeight = _e === void 0 ? 'normal' : _e, _f = _a.fullHeight, fullHeight = _f === void 0 ? false : _f, _g = _a.fullWidth, fullWidth = _g === void 0 ? false : _g, height = _a.height, italic = _a.italic, marginBottom = _a.marginBottom, marginLeft = _a.marginLeft, marginRight = _a.marginRight, marginTop = _a.marginTop, marginX = _a.marginX, marginY = _a.marginY, maxHeight = _a.maxHeight, maxWidth = _a.maxWidth, minHeight = _a.minHeight, minWidth = _a.minWidth, paddingBottom = _a.paddingBottom, paddingLeft = _a.paddingLeft, paddingRight = _a.paddingRight, paddingTop = _a.paddingTop, paddingX = _a.paddingX, paddingY = _a.paddingY, width = _a.width, wordBreak = _a.wordBreak, props = __rest(_a, ["align", "alignSelf", "children", "color", "element", "fontSize", "fontWeight", "fullHeight", "fullWidth", "height", "italic", "marginBottom", "marginLeft", "marginRight", "marginTop", "marginX", "marginY", "maxHeight", "maxWidth", "minHeight", "minWidth", "paddingBottom", "paddingLeft", "paddingRight", "paddingTop", "paddingX", "paddingY", "width", "wordBreak"]);
    var theme = (0, utils_1.useEasyFlexTheme)();
    var processedColor = (0, utils_1.useColor)(color, '');
    ...
    var _h = (0, utils_1.useDistance)({
        ...
        paddingX: paddingX,
        paddingY: paddingY,
    }), margin = _h.margin, padding = _h.padding;
    ...
    return ((0, jsx_runtime_1.jsx)(Element, __assign({ "data-align": align, "data-align-self": alignSelf, "data-color": processedColor, "data-font-size": processedFontSize, "data-font-weight": processedFontWeight, "data-font-style": fontStyle, "data-height": size.height, "data-height-max": size.heightMax, "data-height-min": size.heightMin, "data-margin-bottom": margin.bottom, "data-margin-left": margin.left, "data-margin-right": margin.right, "data-margin-top": margin.top, "data-padding-bottom": padding.bottom, "data-padding-left": padding.left, "data-padding-right": padding.right, "data-padding-top": padding.top, "data-width": size.width, "data-width-max": size.widthMax, "data-width-min": size.widthMin, "data-word-break": wordBreak }, props, { children: children })));
};
exports.Text = Text;
