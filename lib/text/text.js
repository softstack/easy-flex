...
var Text = function (_a) {
    var align = _a.align, alignSelf = _a.alignSelf, children = _a.children, _b = _a.color, color = _b === void 0 ? 'primaryText' : _b, _c = _a.element, element = _c === void 0 ? 'p' : _c, _d = _a.fontSize, fontSize = _d === void 0 ? 'm' : _d, _e = _a.fontWeight, fontWeight = _e === void 0 ? 'normal' : _e, fullWidth = _a.fullWidth, italic = _a.italic, marginBottom = _a.marginBottom, marginLeft = _a.marginLeft, marginRight = _a.marginRight, marginTop = _a.marginTop, marginX = _a.marginX, marginY = _a.marginY, paddingBottom = _a.paddingBottom, paddingLeft = _a.paddingLeft, paddingRight = _a.paddingRight, paddingTop = _a.paddingTop, paddingX = _a.paddingX, paddingY = _a.paddingY, wordBreak = _a.wordBreak, props = __rest(_a, ["align", "alignSelf", "children", "color", "element", "fontSize", "fontWeight", "fullWidth", "italic", "marginBottom", "marginLeft", "marginRight", "marginTop", "marginX", "marginY", "paddingBottom", "paddingLeft", "paddingRight", "paddingTop", "paddingX", "paddingY", "wordBreak"]);
    ...
    var fontStyle = (0, react_1.useMemo)(function () { return (0, utils_1.ifDefined)(italic, function (italic) { return (italic ? 'italic' : 'normal'); }); }, [italic]);
    var _f = (0, utils_1.useDistance)({
        ...
        paddingX: paddingX,
        paddingY: paddingY,
    }), margin = _f.margin, padding = _f.padding;
    ...
    return ((0, jsx_runtime_1.jsx)(Element, __assign({ "data-align": align, "data-align-self": alignSelf, "data-color": processedColor, "data-font-size": processedFontSize, "data-font-weight": processedFontWeight, "data-full-width": processedFullWidth, "data-font-style": fontStyle, "data-margin-bottom": margin.bottom, "data-margin-left": margin.left, "data-margin-right": margin.right, "data-margin-top": margin.top, "data-padding-bottom": padding.bottom, "data-padding-left": padding.left, "data-padding-right": padding.right, "data-padding-top": padding.top, "data-word-break": wordBreak }, props, { children: children })));
};
exports.Text = Text;
