...
exports.Text = (0, react_1.forwardRef)(function (_a, ref) {
    ...
    var processedFontFamily = (0, react_1.useMemo)(function () { return theme.font.family[fontFamily]; }, [fontFamily, theme]);
    var processedFontSize = (0, react_1.useMemo)(function () { return (0, utils_1.getFontSize)(theme, fontSize); }, [fontSize, theme]);
    ...
    var processedLineHeight = (0, react_1.useMemo)(function () { return (0, utils_1.getLineHeight)(theme, lineHeight); }, [lineHeight, theme]);
    ...
    return ((0, jsx_runtime_1.jsx)(Element, __assign({ "data-align": align, "data-align-self": alignSelf, "data-color": processedColor, "data-font-family": processedFontFamily, "data-font-size": processedFontSize, "data-font-weight": processedFontWeight, "data-font-style": fontStyle, "data-height": size.height, "data-height-max": size.heightMax, "data-height-min": size.heightMin, "data-line-height": processedLineHeight, "data-margin-bottom": distance.margin.bottom, "data-margin-left": distance.margin.left, "data-margin-right": distance.margin.right, "data-margin-top": distance.margin.top, "data-padding-bottom": distance.padding.bottom, "data-padding-left": distance.padding.left, "data-padding-right": distance.padding.right, "data-padding-top": distance.padding.top, "data-width": size.width, "data-width-max": size.widthMax, "data-width-min": size.widthMin, "data-word-break": wordBreak, ref: ref }, props, { children: children })));
});
