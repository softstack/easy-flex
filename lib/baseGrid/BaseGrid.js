...
var style = (0, styled_components_1.css)(templateObject_1 || (templateObject_1 = __makeTemplateObject(["\n\tbox-sizing: border-box;\n\tdisplay: grid;\n\tcolumn-gap: ", ";\n\trow-gap: ", ";\n\t", "\n\t", "\n\t", "\n\t", "\n\t", "\n\t", "\n"], ["\n\tbox-sizing: border-box;\n\tdisplay: grid;\n\tcolumn-gap: ", ";\n\trow-gap: ", ";\n\t", "\n\t", "\n\t", "\n\t", "\n\t", "\n\t", "\n"])), function (_a) {
    ...
    return rowGap;
}, border_1.borderStyle, color_1.colorStyle, distance_1.distanceStyle, flexItem_1.flexItemStyle, font_1.fontStyle, size_1.sizeStyle);
...
exports.BaseGrid = (0, react_1.forwardRef)(function (_a, ref) {
    ...
    var processedColumnGap = (0, react_1.useMemo)(function () { return (0, base_1.ifNotUndefined)(columnGap, function (columnGap) { return (0, base_1.getDistance)(theme, columnGap); }); }, [columnGap, theme]);
    var processedRowGap = (0, react_1.useMemo)(function () { return (0, base_1.ifNotUndefined)(rowGap, function (rowGap) { return (0, base_1.getDistance)(theme, rowGap); }); }, [rowGap, theme]);
    ...
    return ((0, jsx_runtime_1.jsx)(Element, __assign({ "data-column-gap": processedColumnGap, "data-row-gap": processedRowGap, "data-distance": theme.distance }, borderStyleProps, colorStyleProps, distanceStyleProps, flexItemStyleProps, fontStyleProps, sizeStyleProps, { ref: ref }, props, { children: children })));
});
