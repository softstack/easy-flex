...
var style = (0, styled_components_1.css)(templateObject_1 || (templateObject_1 = __makeTemplateObject(["\n\tbox-sizing: border-box;\n\tdisplay: grid;\n\talign-content: ", ";\n\talign-items: ", ";\n\tcolumn-gap: ", ";\n\tjustify-content: ", ";\n\tjustify-items: ", ";\n\trow-gap: ", ";\n\t", "\n\t", "\n\t", "\n\t", "\n\t", "\n\t", "\n\t", "\n\t", "\n"], ["\n\tbox-sizing: border-box;\n\tdisplay: grid;\n\talign-content: ", ";\n\talign-items: ", ";\n\tcolumn-gap: ", ";\n\tjustify-content: ", ";\n\tjustify-items: ", ";\n\trow-gap: ", ";\n\t", "\n\t", "\n\t", "\n\t", "\n\t", "\n\t", "\n\t", "\n\t", "\n"])), function (_a) {
    ...
    return rowGap;
}, border_1.borderStyle, color_1.colorStyle, distance_1.distanceStyle, flexItem_1.flexItemStyle, font_1.fontStyle, gridItem_1.gridItemStyle, misc_1.miscStyle, size_1.sizeStyle);
...
var createBaseGrid = function () {
    var BaseGrid = (0, react_1.memo)((0, react_1.forwardRef)(function (_a, ref) {
        var alignContent = _a.alignContent, alignItems = _a.alignItems, alignSelf = _a.alignSelf, backgroundColor = _a.backgroundColor, basis = _a.basis, borderColor = _a.borderColor, borderRadius = _a.borderRadius, borderStyle = _a.borderStyle, borderWidth = _a.borderWidth, children = _a.children, color = _a.color, columnGap = _a.columnGap, displayNone = _a.displayNone, element = _a.element, flex = _a.flex, fontFamily = _a.fontFamily, fontSize = _a.fontSize, fontWeight = _a.fontWeight, fullHeight = _a.fullHeight, fullWidth = _a.fullWidth, grow = _a.grow, height = _a.height, italic = _a.italic, justifyContent = _a.justifyContent, justifyItems = _a.justifyItems, justifySelf = _a.justifySelf, lineHeight = _a.lineHeight, margin = _a.margin, marginBottom = _a.marginBottom, marginHorizontal = _a.marginHorizontal, marginLeft = _a.marginLeft, marginRight = _a.marginRight, marginTop = _a.marginTop, marginVertical = _a.marginVertical, maxHeight = _a.maxHeight, maxWidth = _a.maxWidth, minHeight = _a.minHeight, minWidth = _a.minWidth, opacity = _a.opacity, padding = _a.padding, paddingBottom = _a.paddingBottom, paddingHorizontal = _a.paddingHorizontal, paddingLeft = _a.paddingLeft, paddingRight = _a.paddingRight, paddingTop = _a.paddingTop, paddingVertical = _a.paddingVertical, round = _a.round, rowGap = _a.rowGap, shrink = _a.shrink, underline = _a.underline, visibility = _a.visibility, whiteSpace = _a.whiteSpace, width = _a.width, wordBreak = _a.wordBreak, props = __rest(_a, ["alignContent", "alignItems", "alignSelf", "backgroundColor", "basis", "borderColor", "borderRadius", "borderStyle", "borderWidth", "children", "color", "columnGap", "displayNone", "element", "flex", "fontFamily", "fontSize", "fontWeight", "fullHeight", "fullWidth", "grow", "height", "italic", "justifyContent", "justifyItems", "justifySelf", "lineHeight", "margin", "marginBottom", "marginHorizontal", "marginLeft", "marginRight", "marginTop", "marginVertical", "maxHeight", "maxWidth", "minHeight", "minWidth", "opacity", "padding", "paddingBottom", "paddingHorizontal", "paddingLeft", "paddingRight", "paddingTop", "paddingVertical", "round", "rowGap", "shrink", "underline", "visibility", "whiteSpace", "width", "wordBreak"]);
        ...
        var processedAlignContent = (0, react_1.useMemo)(function () { return (0, base_1.ifDefined)(alignContent, function (alignContent) { return alignContent; }); }, [alignContent]);
        var processedAlignItems = (0, react_1.useMemo)(function () { return (0, base_1.ifDefined)(alignItems, function (alignItems) { return alignItems; }); }, [alignItems]);
        ...
        var processedJustifyContent = (0, react_1.useMemo)(function () { return (0, base_1.ifDefined)(justifyContent, function (justifyContent) { return justifyContent; }); }, [justifyContent]);
        var processedJustifyItems = (0, react_1.useMemo)(function () { return (0, base_1.ifDefined)(justifyItems, function (justifyItems) { return justifyItems; }); }, [justifyItems]);
