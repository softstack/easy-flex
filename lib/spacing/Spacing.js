...
var createSpacing = function () {
    var Spacing = (0, react_1.memo)((0, react_1.forwardRef)(function (_a, ref) {
        var alignSelf = _a.alignSelf, basis = _a.basis, displayNone = _a.displayNone, flex = _a.flex, flip = _a.flip, grow = _a.grow, height = _a.height, shrink = _a.shrink, visibility = _a.visibility, width = _a.width, props = __rest(_a, ["alignSelf", "basis", "displayNone", "flex", "flip", "grow", "height", "shrink", "visibility", "width"]);
