...
var createSpacing = function () {
    var Spacing = (0, react_1.memo)((0, react_1.forwardRef)(function (_a, ref) {
        var _b;
        var alignSelf = _a.alignSelf, basis = _a.basis, bottom = _a.bottom, display = _a.display, flex = _a.flex, flip = _a.flip, grow = _a.grow, height = _a.height, left = _a.left, position = _a.position, right = _a.right, shrink = _a.shrink, top = _a.top, userSelect = _a.userSelect, visibility = _a.visibility, width = _a.width, props = __rest(_a, ["alignSelf", "basis", "bottom", "display", "flex", "flip", "grow", "height", "left", "position", "right", "shrink", "top", "userSelect", "visibility", "width"]);
