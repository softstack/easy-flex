...
var BaseModal = function (_a) {
    ...
    return (0, react_dom_1.createPortal)((0, jsx_runtime_1.jsx)(Background, __assign({ ref: backgroundElement, "data-background-color": theme.modal.backgroundColor, "data-max-child-height": maxChildHeight, "data-max-child-width": maxChildWidth, onClick: handleClick }, props, { children: children })), container);
};
