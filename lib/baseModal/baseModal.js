...
var BaseModal = function (_a) {
    ...
    var processedBackgroundColor = (0, utils_1.useColor)(backgroundColor, theme.modal.backgroundColor);
    (0, react_1.useEffect)(function () {
        if ((0, utils_1.isIAbsoluteSize)(blur) || (blur !== false && theme.modal.blur)) {
            var styleElement_1 = document.createElement('style');
            styleElement_1.textContent = "\n\t\t\t\t#".concat(blurElementId !== null && blurElementId !== void 0 ? blurElementId : theme.modal.blurElementId, " {\n\t\t\t\t\tfilter: blur(").concat((0, utils_1.isIAbsoluteSize)(blur) ? blur : theme.modal.blur, ");\n\t\t\t\t}\n\t\t\t");
    ...
    var container = (0, react_1.useMemo)(function () { var _a; return (_a = document.getElementById(containerElementId !== null && containerElementId !== void 0 ? containerElementId : theme.modal.containerElementId)) !== null && _a !== void 0 ? _a : document.body; }, [containerElementId, theme]);
