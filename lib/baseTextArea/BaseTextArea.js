...
exports.BaseTextArea = (0, react_1.forwardRef)(function (_a, ref) {
    ...
    return ((0, jsx_runtime_1.jsx)(StyledTextArea, __assign({ "data-placeholder-color": processedPlaceholderColor }, borderStyleProps, colorStyleProps, distanceStyleProps, flexItemStyleProps, fontStyleProps, sizeStyleProps, { ref: ref }, props, { children: children })));
});
exports.BaseTextArea.displayName = 'BaseTextArea';
