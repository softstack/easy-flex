...
var createLink = function () {
    var Link = (0, react_1.memo)((0, react_1.forwardRef)(function (_a, ref) {
        var alignSelf = _a.alignSelf, backgroundColor = _a.backgroundColor, basis = _a.basis, children = _a.children, _b = _a.color, color = _b === void 0 ? 'inherit' : _b, flex = _a.flex, fontFamily = _a.fontFamily, fontSize = _a.fontSize, fontWeight = _a.fontWeight, fullHeight = _a.fullHeight, fullWidth = _a.fullWidth, grow = _a.grow, height = _a.height, hoverColor = _a.hoverColor, italic = _a.italic, lineHeight = _a.lineHeight, margin = _a.margin, marginBottom = _a.marginBottom, marginHorizontal = _a.marginHorizontal, marginLeft = _a.marginLeft, marginRight = _a.marginRight, marginTop = _a.marginTop, marginVertical = _a.marginVertical, maxHeight = _a.maxHeight, maxWidth = _a.maxWidth, minHeight = _a.minHeight, minWidth = _a.minWidth, _c = _a.newTab, newTab = _c === void 0 ? false : _c, opacity = _a.opacity, shrink = _a.shrink, underline = _a.underline, whiteSpace = _a.whiteSpace, width = _a.width, wordBreak = _a.wordBreak, props = __rest(_a, ["alignSelf", "backgroundColor", "basis", "children", "color", "flex", "fontFamily", "fontSize", "fontWeight", "fullHeight", "fullWidth", "grow", "height", "hoverColor", "italic", "lineHeight", "margin", "marginBottom", "marginHorizontal", "marginLeft", "marginRight", "marginTop", "marginVertical", "maxHeight", "maxWidth", "minHeight", "minWidth", "newTab", "opacity", "shrink", "underline", "whiteSpace", "width", "wordBreak"]);
        ...
        return ((0, jsx_runtime_1.jsx)(StyledA, __assign({ "data-hover-color": processedHoverColor }, colorStyleProps, flexItemStyleProps, fontStyleProps, marginStyleProps, sizeStyleProps, newTabProps, { ref: ref }, props, { children: children })));
    }));
