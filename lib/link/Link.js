...
exports.Link = (0, react_1.forwardRef)(function (_a, ref) {
    ...
    return ((0, jsx_runtime_1.jsx)(StyledLink, __assign({ "data-hover-color": processedHoverColor }, colorStyleProps, flexItemStyleProps, fontStyleProps, marginStyleProps, sizeStyleProps, newTabProps, { ref: ref }, props, { children: children })));
});
