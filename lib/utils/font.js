...
var useFont = function (_a) {
    var fontFamily = _a.fontFamily, fontSize = _a.fontSize, fontWeight = _a.fontWeight, italic = _a.italic, lineHeight = _a.lineHeight, underline = _a.underline, underlineColor = _a.underlineColor, whiteSpace = _a.whiteSpace, wordBreak = _a.wordBreak;
