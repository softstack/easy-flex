...
var useFont = function (_a) {
    ...
    var theme = (0, exports.useEasyFlexTheme)();
    var processedFontFamily = (0, react_1.useMemo)(function () { return (0, exports.ifNotUndefined)(fontFamily, function (fontFamily) { return theme.font.family[fontFamily]; }); }, [fontFamily, theme]);
    var processedFontSize = (0, react_1.useMemo)(function () { return (0, exports.ifNotUndefined)(fontSize, function (fontSize) { return (0, exports.getFontSize)(theme, fontSize); }); }, [fontSize, theme]);
    var processedFontWeight = (0, react_1.useMemo)(function () { return (0, exports.ifNotUndefined)(fontWeight, function (fontWeight) { return (0, exports.getFontWeight)(theme, fontWeight); }); }, [fontWeight, theme]);
    var processedItalic = (0, react_1.useMemo)(function () { return (0, exports.ifNotUndefined)(italic, function (italic) { return (italic ? 'italic' : 'normal'); }); }, [italic]);
    var processedLineHeight = (0, react_1.useMemo)(function () { return (0, exports.ifNotUndefined)(lineHeight, function (lineHeight) { return (0, exports.getLineHeight)(theme, lineHeight); }); }, [lineHeight, theme]);
    var font = (0, react_1.useMemo)(function () { return ({
...
var useSize = function (_a) {
    var _b = _a.fullHeight, fullHeight = _b === void 0 ? false : _b, _c = _a.fullWidth, fullWidth = _c === void 0 ? false : _c, height = _a.height, heightMax = _a.heightMax, heightMin = _a.heightMin, width = _a.width, widthMax = _a.widthMax, widthMin = _a.widthMin;
    var theme = (0, exports.useEasyFlexTheme)();
