...
var useSize = function (_a) {
    var aspectRatio = _a.aspectRatio, _b = _a.fullHeight, fullHeight = _b === void 0 ? false : _b, _c = _a.fullWidth, fullWidth = _c === void 0 ? false : _c, height = _a.height, maxHeight = _a.maxHeight, maxWidth = _a.maxWidth, minHeight = _a.minHeight, minWidth = _a.minWidth, width = _a.width;
    ...
    var processedHeight = (0, react_1.useMemo)(function () { return (fullHeight ? '100%' : (0, base_1.ifDefined)(height, function (height) { return (0, base_1.getHeight)(theme, height); })); }, [fullHeight, height, theme]);
    ...
    var processedWidth = (0, react_1.useMemo)(function () { return (fullWidth ? '100%' : (0, base_1.ifDefined)(width, function (width) { return (0, base_1.getWidth)(theme, width); })); }, [fullWidth, theme, width]);
