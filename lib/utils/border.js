...
var useBorder = function (_a) {
    ...
    var processedBorderRadius = (0, react_1.useMemo)(function () { return (round ? '99999px' : (0, base_1.ifDefined)(borderRadius, function (borderRadius) { return (0, base_1.getBorderRadius)(theme, borderRadius); })); }, [borderRadius, round, theme]);
