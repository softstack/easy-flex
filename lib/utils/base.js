...
var atMedia = function (width) {
    return function (_a) {
        var theme = _a.theme;
        return "@media (max-width: ".concat((0, exports.toPx)(theme.viewport.threshold[width] - 1), ")");
    };
};
