...
var mergeEasyFlexThemes = function (a, b) {
    if (b === undefined) {
        ...
        for (var _i = 0, _a = Object.entries(a); _i < _a.length; _i++) {
            var key = _a[_i][0];
            // eslint-disable-next-line @typescript-eslint/no-explicit-any
            tmp[key] = (0, exports.mergeEasyFlexThemes)(a[key], b[key]);
        }
        // In b can be members which are not in a
        for (var _b = 0, _c = Object.entries(b); _b < _c.length; _b++) {
            var key = _c[_b][0];
            // eslint-disable-next-line @typescript-eslint/no-explicit-any
            tmp[key] = (0, exports.mergeEasyFlexThemes)(a[key], b[key]);
        }
...
var getBorderRadius = function (theme, borderRadius) { return ((0, exports.isThemeSize)(borderRadius) ? theme.border.radius[borderRadius] : borderRadius); };
