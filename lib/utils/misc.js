...
var useMiscStyleProps = function (_a) {
    var bottom = _a.bottom, displayNone = _a.displayNone, left = _a.left, opacity = _a.opacity, position = _a.position, right = _a.right, top = _a.top, userSelect = _a.userSelect, visibility = _a.visibility;
    ...
    var processedUserSelect = (0, react_1.useMemo)(function () { return (0, base_1.ifDefined)(userSelect, function (userSelect) { return userSelect; }); }, [userSelect]);
